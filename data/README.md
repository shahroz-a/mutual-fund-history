...
| `by_year/YYYY/MM.csv.gz` | Month-level historical daily NAV records committed to the repository. |
...
```bash
python3 scripts/validation.py --input data/latest.csv.gz data/by_year/*/*.csv.gz
```
